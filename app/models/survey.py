...
class Survey(Base):
    ...
    evaluator_user_id: Mapped[str] = mapped_column(String, ForeignKey("users.user_id"), nullable=False)
    ...
    respondent_key: Mapped[str | None] = mapped_column(String, nullable=True)
